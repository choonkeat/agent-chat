...
document.addEventListener("click", function (e) {
  ...
  if (target instanceof HTMLAnchorElement) {
    ...
    if (href && href.startsWith("/source/choonkeat/agent-chat/")) {
      window.open("https://github.com/choonkeat/agent-chat", "_blank");
      return;
    }
    if (href) {
...
Promise.all([
  ...
  if (path === '/tdspec.html' || path === '/') {
    path = pkg + '/';
  }
  app.ports.locationHrefRequested.send(path);
